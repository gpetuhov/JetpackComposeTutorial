...
fun Header(
    ...
    // When setting the color of any elements,
    // prefer using a Surface to do this (instead of using Modifier.background)
    // as it sets an appropriate content color CompositionLocal value.
    Surface(
...
private fun PostMetadata(
    ...
    // If you need to apply multiple styles to some text,
    // then you can use the AnnotatedString class to apply markup,
    // adding SpanStyles to a range of text.
    ...
    // This is how to add alpha to a composable    
